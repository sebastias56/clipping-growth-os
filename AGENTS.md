...
Build incrementally. Implement only the explicitly requested stage and do not scaffold future features. The current product-domain scope contains Creator create/list/get functionality and SourceVideo create/list-by-Creator/get functionality; the React frontend provides the Creator content workspace and individual SourceVideo detail UI. No later business/domain models are implemented.
